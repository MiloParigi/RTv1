...
#    Updated: 2017/10/01 21:08:31 by mparigi          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC			=	gcc
CFLAGS		=	-Wall -Werror -Wextra -fsanitize=address $(DEBUG) -I includes/ -I libs/libft/includes/ -I libs/libvec/includes/ $(LIBXML_H) $(LIB_GTK_H)
OPTI		=	-O3
